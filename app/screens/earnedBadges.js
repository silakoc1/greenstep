...
export default function EarnedBadges() {
  ...
  const users = [
    { id: 1, name: "Minel Sevgen", department: "Yönetim Bilişim Sistemleri", badge: "Eko-Savaşçı", image: require("../../assets/images/women.png") },
    { id: 2, name: "Yağmur Çoban", department: "Yönetim Bilişim Sistemleri", badge: "Çevreleyen", image: require("../../assets/images/women.png") },
  ];
  ...
  return (
    <View className="flex-1 bg-[#F5F5F5] mt-16">
      ...
      <View className="flex-row items-center px-4 py-3 ">
        ...
        Uygulamalı Bilimler Fakültesi Kazanılan Rozetler
        </Text>
      </View>
      ...
      <ScrollView className="flex-1 px-4">
        {users.map((user, index) => (
          <View key={user.id} className="flex-row items-center border-b border-gray-300 p-4">
            ...
            <Text className="text-black  font-bold">{user.badge} </Text>
          </View>
        ))}
      </ScrollView>
